...
CREATE TABLE IF NOT EXISTS `repa`.`sistema_conservacion` (
  ...
  `conservacion_hielera_cantidad` INT NULL DEFAULT NULL,
  `conservacion_refrigerado` TINYINT(1) NULL DEFAULT NULL,
  `conservacion_refrigerado_cantidad` INT NULL DEFAULT NULL,
  `conservacion_otros` TEXT NULL DEFAULT NULL,
  `conservacion_otros_cantidad` INT NULL DEFAULT NULL,
  `solicitante_id` INT NULL DEFAULT NULL,
  `conservacion_cuartofrio` TINYINT(1) NULL DEFAULT NULL,
  `conservacion_cuartofrio_cantidad` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `repa`.`embarcaciones` (
  ...
  `embarcacion_madera_cantidad` INT NULL DEFAULT NULL,
  `embarcacion_fibra_vidrio` TINYINT(1) NULL DEFAULT NULL,
  `embarcacion_fibra_vidrio_cantidad` INT NULL DEFAULT NULL,
  `embarcacion_metal` TINYINT(1) NULL DEFAULT NULL,
  `embarcacion_metal_cantidad` INT NULL DEFAULT NULL,
  `solicitante_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `solicitante_id_UNIQUE` (`solicitante_id` ASC) VISIBLE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `repa`.`instalacion_hidraulica_aireacion` (
  ...
  `hidraulica_bomba_agua_cantidad` INT NULL DEFAULT NULL,
  `hidraulica_aireador` TINYINT(1) NULL DEFAULT NULL,
  `hidraulica_aireador_cantidad` INT NULL DEFAULT NULL,
  `solicitante_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `solicitante_id_UNIQUE` (`solicitante_id` ASC) VISIBLE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `repa`.`instrumentos_medicion` (
  ...
  `solicitante_id` INT NULL DEFAULT NULL,
  `instrumento_temperatura_cantidad` INT NULL DEFAULT NULL,
  `instrumento_oxigeno_cantidad` INT NULL DEFAULT NULL,
  `instrumento_ph_cantidad` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `solicitante_id_UNIQUE` (`solicitante_id` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `repa`.`solicitantes` (
  ...
  `numero_integrantes` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `repa`.`equipo_transporte` (
  ...
  `transporte_lancha_cantidad` INT NULL DEFAULT NULL,
  `transporte_camioneta` TINYINT(1) NULL DEFAULT NULL,
  `transporte_camioneta_cantidad` INT NULL DEFAULT NULL,
  `transporte_cajafria` TINYINT(1) NULL DEFAULT NULL,
  `transporte_cajafria_cantidad` INT NULL DEFAULT NULL,
  `solicitante_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `solicitante_id_UNIQUE` (`solicitante_id` ASC) VISIBLE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `repa`.`unidad_produccion` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `solicitante_id` INT NULL DEFAULT NULL,
  `tipo_estanque_id` INT NULL DEFAULT NULL,
  `instrumento_id` INT NULL DEFAULT NULL,
  `sistema_conservacion_id` INT NULL DEFAULT NULL,
  `equipo_transporte_id` INT NULL DEFAULT NULL,
  `embarcacion_id` INT NULL DEFAULT NULL,
  `instalacion_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `solicitante_id_UNIQUE` (`solicitante_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `repa`.`datos_tecnicos_acuacultura` (
  ...
  `contrato_arrendamiento_anios` INT UNSIGNED NULL DEFAULT NULL COMMENT 'Años de arrendamiento. Solo si la instalación no es propia.',
  ...
  `unidad_produccion_id` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `repa`.`unidad_pesquera` (
  ...
  `emb_madera_cantidad` INT NULL DEFAULT NULL,
  `emb_fibra` TINYINT(1) NULL DEFAULT NULL,
  `emb_fibra_cantidad` INT NULL DEFAULT NULL,
  `emb_metal` TINYINT(1) NULL DEFAULT NULL,
  `emb_metal_cantidad` INT NULL DEFAULT NULL,
  `motores` TINYINT(1) NULL DEFAULT NULL,
  `motores_cantidad` INT NULL DEFAULT NULL,
  `cons_hielera` TINYINT(1) NULL DEFAULT NULL,
  `cons_hielera_cantidad` INT NULL DEFAULT NULL,
  `cons_refrigerador` TINYINT(1) NULL DEFAULT NULL,
  `cons_refrigerador_cantidad` INT NULL DEFAULT NULL,
  `cons_cuartofrio` TINYINT(1) NULL DEFAULT NULL,
  `cons_cuartofrio_cantidad` INT NULL DEFAULT NULL,
  `trans_camioneta` TINYINT(1) NULL DEFAULT NULL,
  `trans_camioneta_cantidad` INT NULL DEFAULT NULL,
  `trans_cajafria` TINYINT(1) NULL DEFAULT NULL,
  `trans_cajafria_cantidad` INT NULL DEFAULT NULL,
  `trans_camion` TINYINT(1) NULL DEFAULT NULL,
  `trans_camion_cantidad` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- (Datos de tu usuario 'Miguel Gil' con CURP ...CSA7)
-- (La contraseña encriptada es la de 'Iguana10.$$')
